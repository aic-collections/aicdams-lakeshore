...
class AIC < RDF::StrictVocabulary("http://definitions.artic.edu/ontology/1.0/")
  ...
  term :isDocumentOf,
       label: "Document Of",
       comment: "Asset is the document of a Citi resource."

  term :isPreferredRepresentationOf,
       label: "Preferred Representation Of",
       comment: "Asset is the preferred representation of a Citi resource."

  term :isPublishable,
       label: "Publishable?",
       comment: "Indicates if this is a publishable resource"

  term :isRepresentationOf,
       label: "Representation Of",
       comment: "Asset is a representation of a Citi resource."
