...
describe Work do
  ...
  describe "#artist" do
    ...
    subject     { described_class.new(artist_uris: [agent.uri]) }
  ...
  describe "#department" do
    ...
    subject { described_class.new(department_uris: [department.uri]) }
  ...
  describe "#current_location" do
    ...
    subject     { described_class.new(current_location_uris: [place.uri]) }
