...
class UidMinter
  ...
  # @param [String, nil] prefix two-letter prefix indicating the type of resource
  ...
  # Returns the MD5 checksum of a UID, formatted as a pseudo-random UUID as per RFC 4122.
  # @param [String] id
